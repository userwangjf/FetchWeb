...
class MyCrawler(Crawler):
    ...
    def Parse_URL_Menu(self):
        ...
        try:
            soup = BeautifulSoup(super().Request_Net(self.url).content, "html5lib")
    ...
    def Parse_URL_Body(self, every_url, html_name):
        ...
        html_template = """
            ...
            """
        try:
            soup = BeautifulSoup(super().Request_Net(every_url).content, 'html5lib')
            # 正文
